...
describe capabilities Tenor does not have yet (see "Not yet buildable" below).
...
Several entries assume behaviour Tenor does not have, and would fail as feature requests rather
