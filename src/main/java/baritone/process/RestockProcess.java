...
public final class RestockProcess extends BaritoneProcessHelper implements IRestockProcess {
    ...
    /**
     * The pre-component equivalent of the item classifications used by {@link #isJunk}.
     * These are the vanilla item families that carried FOOD, TOOL, WEAPON, or EQUIPPABLE
     * semantics in the component-based tree.
     */
