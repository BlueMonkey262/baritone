...
public final class RestockProcess extends BaritoneProcessHelper implements IRestockProcess {
     ...
     * <p>
     * {@code handleClickType} applies each click to the local menu before sending it, so a
    ...
    /**
     * The pre-component equivalent of the item classifications used by {@link #isJunk}. These are
     * the vanilla item families that carried FOOD, TOOL, WEAPON, or EQUIPPABLE semantics in the
     * component-based tree.
     */
